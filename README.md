...
<div class="container">
    ...
    <div class="offer-box">
        <img src="foodbg2.jpg" alt="Weekend meals" class="offer-image">
...
.container {
    width: 100%;
    height: 900px;
    background-image: url("foodbg1.jpg");
...
.menu-container{
    background:url(foodbg2.jpg) no-repeat center/cover;
    padding-top:70px;
}
.menu-title{
    text-align: center;
...
.admin-container{
    height:750px;
    background: url("foodbg3.jpg")center/cover no-repeat;
...
.contact-container{
    min-height: 100vh;
    background: url(foodbg3.jpg)no-repeat center/cover;
    display: flex;
    flex-direction: column;
    align-items: center;
    padding-top: 100px;      
...
```
## OUTPUT:
![alt text](<Screenshot 2026-05-28 225808.png>)
![alt text](<Screenshot 2026-05-28 225839.png>)
![alt text](<Screenshot 2026-05-28 225853.png>)
![alt text](<Screenshot 2026-05-28 225914.png>)
## RESULT:
